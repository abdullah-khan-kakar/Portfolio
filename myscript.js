function assidebar(){   
    ...
    // home_platte.style.display = "none";
    // home_platte.style.justifyContent = "flex-end";
    // home_platte.style.heigth = "15vh";
    // home_text_picture.style.display = "none";
}
function goBack(){
    var asside = document.getElementById("asside");
    var btn1 = document.getElementById("asside_btn1");
    ...
    // home_platte.style.display = "block";
    // platte.style.float = "right";
    // coloricon.style.float = "right";
    // color_icon.style.margin = "20px 8.3% 0px 10px";
    // coloricon.style.float = "right";
    // coloricon.style.float = "right";
    // home_text_picture.style.display = "block";
}
function allcolors(){
